  ...
  return (
    <div className="w-full text-neon-violet z-11 fixed">
      ...
      <div
          ...
          >
            <svg fill="currentColor" viewBox="0 0 20 20" className="w-6 h-6">
              <path fillRule="evenodd"
                ...
                1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM9 15a1 1 0
                011-1h6a1 1 0 110 2h-6a1 1 0 01-1-1z"
                clipRule="evenodd"/>
              {/* <path x-show="open" fillRule="evenodd" d="M4.293 4.293a1
               1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414
        ...
        <nav className="flex-col flex-grow pt-4 hidden
